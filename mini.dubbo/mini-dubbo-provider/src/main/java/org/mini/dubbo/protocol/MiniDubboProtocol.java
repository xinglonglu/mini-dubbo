...
import org.mini.dubbo.transport.Server;
import org.mini.dubbo.transport.Transporters;
import org.mini.dubbo.transport.netty.NettyServiceHandler;
...
public class MiniDubboProtocol implements Protocol {
    ...
    private Server createServer(String address, int port) throws InterruptedException {
        ...
        Server server = Transporters.bind(address,port,(org.mini.dubbo.transport.netty.ChannelHandler) handler);
